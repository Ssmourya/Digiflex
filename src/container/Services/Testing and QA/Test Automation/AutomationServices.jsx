      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            <Paragraph>
              At Digiflex, we streamline software delivery with customized, high-quality automation solutions. Our expert team leverages the latest technologies to deliver robust automation solutions that reduce time to market, improve product quality, and minimize manual testing efforts.
            </Paragraph>
          </div>
        </div>
