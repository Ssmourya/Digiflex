      ...
      <WrapperContainer>
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="text-center mb-10 md:mb-16">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6 leading-tight text-blue-700 px-2">
            ...
            <div className="order-1 lg:order-2">
              <div className="space-y-6 sm:space-y-8 md:space-y-10">
                ...
                <div className="flex items-start gap-4 md:gap-6">
                  <div className="bg-blue-50 p-3 md:p-4 rounded-xl md:rounded-2xl flex-shrink-0">
                    <Lightbulb className="w-5 h-5 md:w-7 md:h-7 text-blue-600" />
                  </div>
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Consulting</h3>
                ...
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">UI & UX Design</h3>
                    <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                ...
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Testing & QA</h3>
                    <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
