                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 lg:gap-4 xl:gap-8">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 lg:gap-4 xl:gap-8">
                    <div className="flex -space-x-2 sm:-space-x-3 lg:-space-x-2 xl:-space-x-3">
                      <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=96&h=96&fit=crop&crop=faces&q=80" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-10 lg:h-10 xl:w-12 xl:h-12 rounded-full border-2 border-white" alt="Client" />
                      <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=96&h=96&fit=crop&crop=faces&q=80" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-10 lg:h-10 xl:w-12 xl:h-12 rounded-full border-2 border-white" alt="Client" />
                      <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=96&h=96&fit=crop&crop=faces&q=80" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-10 lg:h-10 xl:w-12 xl:h-12 rounded-full border-2 border-white" alt="Client" />
                      <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=96&h=96&fit=crop&crop=faces&q=80" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-10 lg:h-10 xl:w-12 xl:h-12 rounded-full border-2 border-white" alt="Client" />
                    </div>
                    
                    <div>
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-4 h-4 sm:w-5 sm:h-5 lg:w-4 lg:h-4 xl:w-5 xl:h-5 fill-yellow-400 text-yellow-400" />
                        ))}
                      </div>
                      <div className="text-xs sm:text-sm lg:text-xs xl:text-sm mt-1">Original reviews</div>
                    </div>
                  </div>
                </div>
              </div>
