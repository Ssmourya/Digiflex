...
export default function MachineLearningDevelopment() {
    ...
    const text = "Machine Learning Development";
                ...
                <div className="relative flex items-center justify-center z-20 min-h-screen px-4 py-20">
                    <div className="max-w-6xl mx-auto text-center transform hover:scale-105 transition-transform duration-700">
                        ...
                        <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-12 animate-glow">
                            ML development is the process of designing, training, and optimizing machine learning models to analyze data, make predictions, and automate decision-making. ml models are used for tasks like classification, regression, clustering, and anomaly detection.
                        </p>
                        {/* Floating Orbs */}
                        {[...Array(5)].map((_, i) => (
                            <div
