const GoogleCloudServicesFAQData = [
    ...
    {
      question: "How secure is Google Cloud for storing and managing data?",
      answer:
  ...
  const AzureCloudServicesFAQData = [
    ...
    {
      question: "How secure is Microsoft Azure for data storage and management?",
      answer:
  ...
  const AWSCloudServicesFAQData = [
    ...
    {
      question: "How secure is AWS Cloud for data storage and management?",
      answer:
  ...
  const CloudMigrationFAQData = [
    
    {
      question: "Why should my business migrate to the cloud?",
      answer:
    ...
    },
    {
      ...
      answer:
        "The duration of cloud migration depends on the complexity of your infrastructure. A simple migration may take a few weeks, while a large-scale enterprise migration can take months.",
    },
    {
  ...
  const IntercloudMigrationFAQData = [
    {
      question: "Why should businesses consider Intercloud Migration?",
      answer:
    ...
    {
      question: "What security measures are taken during Intercloud Migration?",
      answer:
  ...
  const CloudNativeServicesFAQData = [
    {
      question: "What are Cloud Native Services?",
      answer:
        "Cloud Native Services are a set of technologies and practices designed to build, deploy, and manage applications in cloud environments. These services leverage containers, microservices, Kubernetes, and serverless computing for scalability and efficiency.",
    },
    {
      question: "What are the benefits of Cloud Native Services?",
      answer:
    ...
    {
      question: "How secure are Cloud Native Services?",
      answer:
        "Cloud Native architectures enhance security by using automated security policies, identity access management (IAM), container isolation, and compliance-driven best practices.",
    },
    {
      question: "What is the difference between Cloud Native and traditional cloud computing?",
      answer:
  ...
  const CloudOptimizationFAQData = [
    {
      question: "What is cloud optimization, and why is it important?",
      answer:
    ...
    {
      question: "How often should I optimize my cloud environment?",
      answer:
    ...
    {
      question: "Can cloud optimization help with sustainability and energy efficiency?",
      answer:
        "Absolutely! By optimizing workloads and reducing redundant resource usage, cloud optimization minimizes energy consumption and contributes to a more sustainable cloud infrastructure.",
    },
  ];
  ...
  export { 
    GoogleCloudServicesFAQData,
    AzureCloudServicesFAQData,
    AWSCloudServicesFAQData,
    CloudMigrationFAQData,
    IntercloudMigrationFAQData,
    CloudNativeServicesFAQData,
    CloudOptimizationFAQData,
    CemFaq,
    BlockchainDevFaqs,
    IosfaqData,
    AndroidfaqData,
