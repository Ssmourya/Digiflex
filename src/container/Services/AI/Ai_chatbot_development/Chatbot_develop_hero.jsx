...
const Chatbot_develop_hero = () => {
  const letterRefs = useRef([]);
  const text = "AI Chatbot Development";
    ...
    <div className="relative w-full min-h-screen overflow-hidden ">
      ...
      <div className="relative flex items-center justify-center z-20 min-h-screen px-4 py-20">
        <div className="max-w-6xl mx-auto text-center transform hover:scale-105 transition-transform duration-700">
          ...
          AI Chatbot Development involves creating intelligent virtual assistants using NLP and machine learning to automate conversations, enhance user experience, and provide real-time support.
          </p>
          {/* Floating Orbs */}
          {[...Array(5)].map((_, i) => (
            <div
...
export default Chatbot_develop_hero;