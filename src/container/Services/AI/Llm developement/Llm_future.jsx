...
const industries = [
  ...
  },
  {
    ...
    description:"Our expertise in multimodal AI enables LLMs to process text, audio, and video, unlocking next-gen applications in autonomous systems, smart surveillance, and intelligent automation.",
  },
  {
  ...
  },
  {
    ...
    description:"Our AI-driven virtual assistants and chatbots provide context-aware, human-like interactions, improving customer service, smart home automation, and enterprise AI solutions.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Heading>
            ...
            <p className="text-lg text-gray-600">
              The future of Large Language Models (LLMs) looks promising and transformative, with advancements expected in several key areas.
            </p>
          </div>
