...
import Fashion from '../../../../assets/Fashion-boutiqe.jpg';
import GourmetFoods from '../../../../assets/GourmetFoods.webp';
import TechGadgets from '../../../../assets/TechGadgets.jpg';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <div className="mt-4 max-w-3xl mx-auto">
              <Paragraph>
                See how we've helped businesses overcome challenges and achieve remarkable results with customized OpenCart solutions.
              </Paragraph>
            </div>
          </div>
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                ...
                <div className="md:w-1/2 relative mb-8 md:mb-0">
                  <div className={`absolute -bottom-6 -right-6 w-full h-full ${study.color} opacity-20 rounded-2xl -z-10 transform rotate-3`}></div>
                ...
                <div className="md:w-1/2">
                  <div className={`inline-block px-3 py-1 rounded-full ${study.color} bg-opacity-10 text-sm font-medium mb-4`}>
                    {study.industry}
                  </div>
                  <Subheading>How {study.client} Transformed Their eCommerce Experience</Subheading>
